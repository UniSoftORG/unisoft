...
exports.findObjectByValue = void 0;
 ...
 */
var findObjectByValue = function (data, value, key, parent, nestedKey) {
    if (nestedKey === void 0) { nestedKey = "children"; }
    return __awaiter(void 0, void 0, void 0, function () {
        var foundObject;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, helpers_1.forRecursive)(data, function (item, index, parent) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            if (item[key] === value) {
                                foundObject = { object: item, parent: parent, index: index };
                            }
                            return [2 /*return*/];
                        });
                    }); }, nestedKey)];
...
exports.findObjectByValue = findObjectByValue;
