import {isAccessible, hasKey, hasAnyKey} from "../../src/checkers";
...
describe('hasAny function', () => {
  it('should return true if any key exists', () => {
    expect(hasAnyKey({ key1: 'value1', key2: 'value2' }, ['key1', 'noKey'])).toBe(true);
  });

  it('should return false if no keys exist', () => {
    expect(hasAnyKey({ key1: 'value1', key2: 'value2' }, ['noKey1', 'noKey2'])).toBe(false);
  });
