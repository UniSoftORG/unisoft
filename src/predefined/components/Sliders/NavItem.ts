...
const ternaryUtil = (trueReturn: string | number, falseReturn: string | number) => ternaryCondition(
    {
...
export const NavItem = generateElement('Item', {
            ...
            elementAttributes: {
                className: 'lg:flex z-40 lg:justify-center items-center lg:px-3 lg:py-2 rounded-full',
            },
            children: [
                generateElement('Thumbnail', {
                    elementAttributes: {
                        className: `w-full blue-purple border-0 py-4 mr-4 hidden lg:block rounded-full transition duration-500 ease-in-out ${ternaryUtil("opacity-100", "opacity-0",)}`,
                    },
                    rendererDynamic: [
                ...
                generateElement('ImageWrapper', {
                    ...
                    children: [
                        generateImage('NavImage', {
                            elementAttributes: {
                                className: 'w-16 h-16 lg:h-full lg:w-full rounded-full object-cover',
                            },
                            receiveAttributes: {
