...
export const LinkHover = generateElement(
    "NavLinkHover",
    {
        ...
        elementAttributes: {
            className: `${getAttribute('hovered')} absolute cursor-default box bg-neural-dark bg-opacity-90 arrow-center w-48 rounded-2xl flex flex-col justify-center items-center pl-4  py-3 pr-2 text-center z-40`,
