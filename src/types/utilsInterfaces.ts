import {ExtractOptions, FilterOptions, FlexibleObj, MapOption, Nested, ValueReplacement} from "unisoft";
...
export interface recursiveKeyCollectionAttributes<ObjectType, KeyType extends string = string> {
...
export interface sanitizeObjectKeysRecursiveAttributes<T extends Record<any, any>> {
...
export interface setByDotNotationAttributes<T, K extends keyof any = keyof any> {
    obj: T; // Default: null
    path: string; // Default: null
...
export interface excludeKeysAttributes<T extends Record<string, any>, K extends keyof T> {
    obj: T; // Default: null
