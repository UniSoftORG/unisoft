import {ApiResult, IGenericApiError, SupportedApiMethods} from '@/interfaces/api/generics';
...
export default class SingletonApiRequest {
    ...
    private static async getResponse<Type>(response: Response): Promise<ApiResult<Type>> {
